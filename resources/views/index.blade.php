                ...
                <div class="col-lg-12">
                    ...
                    <div class="offers">
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <h4 class="h1 heading-title">{{ $laravel_framework->name }}</h4>
                                    <div class="heading-line">
                                        <span class="short-line"></span>
                                        <span class="long-line"></span>
                                    </div>
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($laravel_framework->posts()->orderBy('created_at', 'DESC')->take(3)->get() as $laravel)
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb">
                                                <img src="{{$laravel->featured}}" alt="our case">
                                            </div>
                                            <h6 class="case-item__title text-center"><a href="{{route('post.single', ['slug' => $laravel->slug])}}">{{$laravel->title}}</a></h6>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
